...
//
// All the deciding is `core`'s (`dueAlerts` / `recordAlerts`); this only wires
// the records to the store and the due Alerts to the notifier.
...
import { dueAlerts, recordAlerts, type AlertRecord } from '../core';
import {
...
export function AlertProvider({ children }: { children: React.ReactNode }) {
  ...
  }, [ready, budgetsReady, settingsReady, views, cycle]);
